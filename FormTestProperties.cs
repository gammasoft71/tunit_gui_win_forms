...
namespace tunit {
  public partial class FormTestProperties : Form {
    ...
    public FormTestProperties(string testName, string testFixtureName, string file, TestStatus testStatus, string[] messages, string stackTrace, TimeSpan duration) {
      InitializeComponent();
